    ...
    <section id="pricing" class="projects" aria-label="Pricing">
          ...
          <div class="project-list">
            ...
            <div class="project highlight" role="article" aria-label="Business Website Package">
              <div class="project-title">Business Website — KES 40,000–70,000 <div class="badge">Most Popular</div></div>
              <div class="project-meta">
              ...
              <p class="tiny-note" style="color: white;">
            Most clients choose this package for long-term growth and branding.
          </p>
            </div>
          ...
          <p class="tiny-note">
            Hosting and domain costs are paid separately to providers. We’ll guide you on the best options for your project.
          </p>
          <section class="faq">
